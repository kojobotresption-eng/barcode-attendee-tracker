  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:shadow-medium transition-bounce shadow-soft",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft transition-smooth",
        scanner: "bg-gradient-primary text-primary-foreground hover:shadow-strong transition-bounce shadow-medium h-14 text-lg font-semibold",
      },
      size: {
